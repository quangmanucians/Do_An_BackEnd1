        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <form action="" method="post">
                    ...
                    <input value="<?php if(isset($_POST['user'])) echo $_POST['user'];
                        else if(isset($_COOKIE['username'])) echo $_COOKIE['username']?>" type="text" name="user" class="form-control">
                    <div class="error">
                        <?php if(isset($error_user)) echo $error_user ?>
                    </div>
                    <label>Password</label>
                    <input value="<?php if(isset($_POST['pass'])) echo $_POST['pass'];
                        else if(isset($_COOKIE['password'])) echo $_COOKIE['password']?>" type="password" name="pass" class="form-control">
                    <div class="error">
